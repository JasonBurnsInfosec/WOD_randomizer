...
#This writes to a local index.html file that apache is presenting. You can modify to have python host if you want.
import random
import requests
...
local_html = open("/opt/homebrew/var/www/index.html", "w") #open the local html file to write the WOD to, you likely need to change this on your machine
local_html.write(html_clock + '\n' + page_wod_clean) #write output to local html file
